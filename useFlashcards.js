...
export function useFlashcards() {
  ...
  const FLASHCARDS_PADRAO = [
    {id:1,materia:"Língua Portuguesa",frente:"O que é fonética?",verso:"Estudo dos sons da fala (fonemas).",box:1,lastReviewed:null},
    {id:2,materia:"Língua Portuguesa",frente:"O que é fonologia?",verso:"Estudo da função dos sons em uma língua.",box:1,lastReviewed:null},
    {id:3,materia:"Língua Portuguesa",frente:"Diferencie fonema de letra.",verso:"Fonema = som; letra = representação gráfica. Ex: 'táxi' tem 4 fonemas e 4 letras; 'hoje' tem 3 fonemas e 4 letras.",box:1,lastReviewed:null},
    {id:4,materia:"Língua Portuguesa",frente:"O que é encontro consonantal?",verso:"Sequência de duas ou mais consoantes sem vogal entre elas. Ex: 'prato' (pr), 'flor' (fl).",box:1,lastReviewed:null},
    {id:5,materia:"Língua Portuguesa",frente:"O que é dígrafo?",verso:"Duas letras representando um único fonema. Ex: 'ch', 'lh', 'nh', 'qu', 'gu', 'ss', 'rr', 'sc'.",box:1,lastReviewed:null},
    {id:6,materia:"Língua Portuguesa",frente:"O que é ditongo?",verso:"Encontro de duas vogais na mesma sílaba. Ex: 'cai-xa', 'herói'.",box:1,lastReviewed:null},
    {id:7,materia:"Língua Portuguesa",frente:"O que é hiato?",verso:"Encontro de duas vogais em sílabas diferentes. Ex: 'sa-ú-de', 'po-é-ti-co'.",box:1,lastReviewed:null},
    {id:8,materia:"Língua Portuguesa",frente:"Regra de acentuação: paroxítonas",verso:"Acentuam-se paroxítonas terminadas em: l, n, r, x, i, is, us, um, uns, ão, ãos, ei, eis, ps. Ex: 'fácil', 'hífen', 'tórax'.",box:1,lastReviewed:null},
    {id:9,materia:"Língua Portuguesa",frente:"Regra de acentuação: proparoxítonas",verso:"Todas as proparoxítonas são acentuadas. Ex: 'médico', 'página', 'lâmpada'.",box:1,lastReviewed:null},
    {id:10,materia:"Língua Portuguesa",frente:"Regra de acentuação: oxítonas",verso:"Acentuam-se oxítonas terminadas em: a, e, o, em, ens. Ex: 'sofá', 'café', 'armazém'.",box:1,lastReviewed:null},
    {id:11,materia:"Língua Portuguesa",frente:"Por que 'ideia' não leva mais acento?",verso:"Pelo Novo Acordo Ortográfico, ditongos abertos 'ei' e 'oi' em paroxítonas perderam o acento.",box:1,lastReviewed:null},
    {id:12,materia:"Língua Portuguesa",frente:"Classes gramaticais: substantivo",verso:"Palavra que nomeia seres, objetos, sentimentos, etc. Ex: 'casa', 'amor', 'Petrobras'.",box:1,lastReviewed:null},
    {id:13,materia:"Língua Portuguesa",frente:"Classes gramaticais: adjetivo",verso:"Palavra que caracteriza o substantivo. Ex: 'grande', 'eficiente', 'químico'.",box:1,lastReviewed:null},
    {id:14,materia:"Língua Portuguesa",frente:"Classes gramaticais: verbo",verso:"Palavra que indica ação, estado ou fenômeno. Ex: 'analisar', 'ser', 'chover'.",box:1,lastReviewed:null},
    {id:15,materia:"Língua Portuguesa",frente:"O que é sujeito?",verso:"Termo sobre o qual se declara algo. Ex: 'O técnico analisou a amostra' → sujeito: 'O técnico'.",box:1,lastReviewed:null},
    {id:16,materia:"Língua Portuguesa",frente:"O que é predicado?",verso:"Tudo que se declara sobre o sujeito. Ex: 'O técnico analisou a amostra' → predicado: 'analisou a amostra'.",box:1,lastReviewed:null},
    {id:17,materia:"Língua Portuguesa",frente:"O que é objeto direto?",verso:"Complemento verbal sem preposição obrigatória. Ex: 'Ele comprou um livro'. 'um livro' = OD.",box:1,lastReviewed:null},
    {id:18,materia:"Língua Portuguesa",frente:"O que é objeto indireto?",verso:"Complemento verbal com preposição obrigatória. Ex: 'Preciso de ajuda'. 'de ajuda' = OI.",box:1,lastReviewed:null},
    {id:19,materia:"Língua Portuguesa",frente:"O que é adjunto adverbial?",verso:"Termo que indica circunstância (tempo, lugar, modo, etc.). Ex: 'Chegou cedo'. 'cedo' = adj. adverbial de tempo.",box:1,lastReviewed:null},
    {id:20,materia:"Língua Portuguesa",frente:"O que é crase?",verso:"Fusão da preposição 'a' com o artigo 'a' ou com o 'a' de pronomes. Usa-se acento grave (`). Ex: 'Vou à escola'.",box:1,lastReviewed:null},
    {id:21,materia:"Língua Portuguesa",frente:"Quando usar 'mal' e 'mau'?",verso:"'Mal' = advérbio (opõe-se a 'bem'). 'Mau' = adjetivo (opõe-se a 'bom'). Ex: 'Ele está mal' / 'Ele é um mau profissional'.",box:1,lastReviewed:null},
    {id:22,materia:"Língua Portuguesa",frente:"Quando usar 'mais' e 'mas'?",verso:"'Mas' = conjunção adversativa (oposição). 'Mais' = advérbio de intensidade. Ex: 'Estudou, mas não passou' / 'Quero mais tempo'.",box:1,lastReviewed:null},
    {id:23,materia:"Língua Portuguesa",frente:"O que é figura de linguagem?",verso:"Recurso estilístico para dar expressividade ao texto. Ex: metáfora, metonímia, hipérbole, antítese.",box:1,lastReviewed:null},
    {id:24,materia:"Língua Portuguesa",frente:"O que é metáfora?",verso:"Figura de palavra que emprega um termo com significado diferente do usual, por comparação implícita. Ex: 'Ele é um leão'.",box:1,lastReviewed:null},
    {id:25,materia:"Língua Portuguesa",frente:"O que é concordância verbal?",verso:"O verbo concorda com o sujeito em número e pessoa. Ex: 'O aluno estudou' / 'Os alunos estudaram'.",box:1,lastReviewed:null},
    {id:26,materia:"Língua Portuguesa",frente:"O que é regência verbal?",verso:"Relação entre o verbo e seus complementos (com ou sem preposição). Ex: 'Assistir ao filme' (OI) / 'Assistir o professor' (OD).",box:1,lastReviewed:null},
    {id:27,materia:"Língua Portuguesa",frente:"O que é período composto?",verso:"Frase com mais de uma oração. Ex: 'Estudou muito, mas não passou'.",box:1,lastReviewed:null},
    {id:28,materia:"Língua Portuguesa",frente:"O que é oração subordinada?",verso:"Oração que depende de outra (principal). Ex: 'Preciso que você estude' → 'que você estude' é subordinada.",box:1,lastReviewed:null},
    {id:29,materia:"Língua Portuguesa",frente:"O que são conectivos?",verso:"Palavras que ligam orações ou termos. Ex: conjunções (e, mas, porque, quando), preposições, pronomes relativos.",box:1,lastReviewed:null},
    {id:30,materia:"Língua Portuguesa",frente:"Funções da linguagem: função referencial",verso:"Foco na informação, no contexto. Ex: notícias, manuais técnicos. Predomina a 3ª pessoa.",box:1,lastReviewed:null},
    {id:31,materia:"Língua Portuguesa",frente:"Funções da linguagem: função emotiva",verso:"Foco no emissor, expressão de sentimentos. Ex: poemas, diários. Predomina a 1ª pessoa.",box:1,lastReviewed:null},
    {id:32,materia:"Língua Portuguesa",frente:"Funções da linguagem: função conativa",verso:"Foco no receptor, intenção de convencer. Ex: propagandas, discursos políticos. Uso de imperativo.",box:1,lastReviewed:null},
    {id:33,materia:"Língua Portuguesa",frente:"Funções da linguagem: função fática",verso:"Foco no canal de comunicação. Ex: 'Alô?', 'Entendeu?', 'Está me ouvindo?'.",box:1,lastReviewed:null},
    ...
    {id:101,materia:"🛢️ Processos de Petróleo",frente:"O que é GOSP?",verso:"Group Gathering Station / separação gás-óleo-água. Conjunto de vasos separadores (bifásicos e trifásicos) que separa as fases produzidas no poço antes do refino.",box:1,lastReviewed:null},
    {id:102,materia:"🛢️ Processos de Petróleo",frente:"Diferença entre destilação atmosférica e a vácuo",verso:"Atmosférica: separa frações leves/médias à pressão ambiente. A vácuo: reduz a pressão para destilar frações pesadas sem craqueá-las termicamente.",box:1,lastReviewed:null},
    {id:103,materia:"🛢️ Processos de Petróleo",frente:"O que é craqueamento catalítico fluidizado (FCC)?",verso:"Processo que quebra moléculas pesadas em mais leves (ex: gasolina) usando catalisador zeolítico em leito fluidizado.",box:1,lastReviewed:null},
    {id:104,materia:"🛢️ Processos de Petróleo",frente:"Para que serve a hidrodessulfurização (HDS)?",verso:"Remove enxofre de frações como diesel e gasolina usando hidrogênio e catalisador, reduzindo emissões de SOx.",box:1,lastReviewed:null},
    {id:105,materia:"🛢️ Processos de Petróleo",frente:"O que é octanagem (RON/MON)?",verso:"Medida da resistência da gasolina à detonação prematura. RON = condição de teste mais branda; MON = condição mais severa.",box:1,lastReviewed:null},
    {id:106,materia:"🛢️ Processos de Petróleo",frente:"O que é índice de cetano?",verso:"Mede a facilidade de autoignição do diesel — quanto maior o cetano, mais rápida e eficiente a combustão no motor.",box:1,lastReviewed:null},
    {id:107,materia:"🛢️ Processos de Petróleo",frente:"O que é reforma catalítica?",verso:"Processo que converte nafta em gasolina de alta octanagem (reformado), usando catalisador à base de platina.",box:1,lastReviewed:null},
    {id:108,materia:"🛢️ Processos de Petróleo",frente:"O que caracteriza o pré-sal?",verso:"Reservatórios de petróleo sob espessa camada de sal, em águas ultra-profundas — exigem tecnologia avançada de perfuração e elevação.",box:1,lastReviewed:null},
    {id:109,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"O que é PGR (NR 1)?",verso:"Programa de Gerenciamento de Riscos — substituiu o PPRA, exige inventário de riscos e plano de ação da empresa.",box:1,lastReviewed:null},
    {id:110,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"O que a NR 33 regula?",verso:"Trabalho em espaço confinado: identificação, permissão de entrada, monitoramento de atmosfera, resgate.",box:1,lastReviewed:null},
    {id:111,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"O que é LOTO?",verso:"Lockout/Tagout — bloqueio e etiquetagem de fontes de energia antes de manutenção, para evitar acionamento acidental.",box:1,lastReviewed:null},
    {id:112,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"Hierarquia de controles de risco (da mais para a menos eficaz)",verso:"Eliminação → substituição → controle de engenharia → controle administrativo → EPI (o EPI é a última barreira, não a primeira).",box:1,lastReviewed:null},
    {id:113,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"O que é APR?",verso:"Análise Preliminar de Riscos — identifica perigos de uma atividade antes de executá-la, definindo medidas de controle.",box:1,lastReviewed:null},
    {id:114,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"Diferença entre insalubridade e periculosidade",verso:"Insalubridade (NR 15): exposição a agentes nocivos à saúde acima do limite de tolerância. Periculosidade (NR 16): risco acentuado à integridade física (ex: inflamáveis, explosivos).",box:1,lastReviewed:null},
    {id:115,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"O que é PAIR?",verso:"Perda Auditiva Induzida por Ruído — doença ocupacional causada por exposição prolongada a ruído acima dos limites.",box:1,lastReviewed:null},
    {id:116,materia:"🔐 Segurança, Saúde e Ambiente (SSH)",frente:"Etapas do licenciamento ambiental",verso:"Licença Prévia (LP) → Licença de Instalação (LI) → Licença de Operação (LO).",box:1,lastReviewed:null},
    {id:117,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"O que é rastreabilidade metrológica?",verso:"Cadeia ininterrupta de comparações que liga o resultado de uma medição a um padrão de referência, com incertezas conhecidas.",box:1,lastReviewed:null},
    {id:118,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"Diferença entre incerteza Tipo A e Tipo B",verso:"Tipo A: avaliada por método estatístico (repetição de medições). Tipo B: avaliada por outros meios, como certificados de calibração ou especificações do fabricante.",box:1,lastReviewed:null},
    {id:119,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"Como calibrar um pHmetro?",verso:"Com soluções-tampão de pH conhecido (geralmente 4,0; 7,0 e 10,0), em pelo menos 2 pontos que abranjam a faixa de uso.",box:1,lastReviewed:null},
    {id:120,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"O que são Cp e Cpk?",verso:"Índices de capacidade do processo. Cp compara a dispersão do processo com os limites de especificação; Cpk também considera se o processo está centrado.",box:1,lastReviewed:null},
    {id:121,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"Para que servem as cartas de controle X-R?",verso:"Monitoram média (X) e amplitude (R) de um processo ao longo do tempo, detectando causas especiais de variação.",box:1,lastReviewed:null},
    {id:122,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"O que são LOD e LOQ?",verso:"LOD (limite de detecção): menor quantidade detectável de um analito. LOQ (limite de quantificação): menor quantidade que pode ser medida com precisão aceitável.",box:1,lastReviewed:null},
    {id:123,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"O que é ISO/IEC 17025?",verso:"Norma de requisitos para laboratórios de calibração e ensaios, cobrindo competência técnica e sistema de gestão.",box:1,lastReviewed:null},
    {id:124,materia:"⚖️ Metrologia e Controle de Qualidade",frente:"O que avalia o teste de Shapiro-Wilk?",verso:"Se uma amostra segue distribuição normal — um pré-requisito comum antes de aplicar testes estatísticos paramétricos (ANOVA, t-test).",box:1,lastReviewed:null},
  ];
